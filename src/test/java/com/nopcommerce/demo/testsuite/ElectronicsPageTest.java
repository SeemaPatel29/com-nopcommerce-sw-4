...
public class ElectronicsPageTest extends BaseTest {
    ...
    public void verifyUserShouldNavigateToCellPhonesPageSuccessfully() throws InterruptedException {
        ...
        homePage.selectMenu("Cell phones");

        //1.3 Verify the text “Cell phones”
        Thread.sleep(1000);
        Assert.assertEquals(homePage.getHeadingText(),"Cell phones","Navigation is not successful");
    }
    @Test
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        Assert.assertEquals(homePage.getHeadingText(),"Shopping cart","Shopping cart not displayed successfully");
        Thread.sleep(2000);
        ...
        Assert.assertEquals(homePage.getHeadingText(),"Welcome, Please Sign In!","Checkout navigation not succeed");

        //2.18 Click on “REGISTER” tab
        shoppingCartPage.clickOnRegister();

        //2.19 Verify the text “Register”
        Assert.assertEquals(homePage.getHeadingText(),"Register","Navigation not successful");

        //2.20 Fill the mandatory fields
        registerPage.enterFirstname("Peter");
        registerPage.enterLastname("Rabbit");
        String email= "prime-" + UUID.randomUUID().toString() + "@example.com";
        ...
        billingPage.enterPostcode("Nw99su");
        billingPage.enterPhoneNumber("7896543456");
        ...
        Assert.assertEquals(homePage.getHeadingText(),"Welcome to our store","Message not displayed");
