...
public class ComputerPageTest extends BaseTest {
   HomePage homePage = new HomePage();
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        Assert.assertEquals("Build your own computer",homePage.getHeadingText(),"Not right product");
        ...
        billingPage.enterFirstname("Peter");
        billingPage.enterLastname("Rabbit");
        billingPage.enterEmail("prabbit@gmail.com");
        billingPage.selectCountry("United Kingdom");
        billingPage.enterCity("London");
        billingPage.enterAddress("23, London road");
        billingPage.enterPostcode("HA42SU");
        billingPage.enterPhoneNumber("7896541987");
        ...
        billingPage.enterCardHolderName("Mario Cart");
        billingPage.enterCardNumber("5115105105105230");
